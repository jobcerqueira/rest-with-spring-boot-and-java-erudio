...
public class PersonControllerJsonTest extends AbstractIntegrationTest{
	...
	public void testCreate() throws JsonMappingException, JsonProcessingException {
		...
		assertEquals("Nome", createdPerson.getFirstName());
		assertEquals("Sobrenome", createdPerson.getLastName());
	...
	public void testFindById() throws JsonMappingException, JsonProcessingException {
		...
		assertEquals("Nome", persistedPerson.getFirstName());
		assertEquals("Sobrenome", persistedPerson.getLastName());
		assertEquals("Rua 1", persistedPerson.getAddress());
